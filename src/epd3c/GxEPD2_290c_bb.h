...
#ifndef _GxEPD2_290c_bb_H_
#define _GxEPD2_290c_bb_H_

#include "GxEPD2_EPD_bb.h"

class GxEPD2_290c_bb : public GxEPD2_EPD_bb
{
  public:
    // attributes
...
//    static const uint16_t partial_refresh_time = 15000; // ms, e.g. 14845408us
    static const uint16_t full_refresh_time = 25000; // ms, e.g. 14845408us
    static const uint16_t partial_refresh_time = 25000; // ms, e.g. 14845408us
    // constructor
    GxEPD2_290c_bb(int8_t cs, int8_t dc, int8_t rst, int8_t busy, SPI_TYPE *xspi);
    // methods (virtual)
