...
#ifndef _GxEPD2_EPD_bb_H_
#define _GxEPD2_EPD_bb_H_
...
class GxEPD2_EPD_bb
{
  public:
    ...
    // constructor
    GxEPD2_EPD_bb(int8_t cs, int8_t dc, int8_t rst, int8_t busy, int8_t busy_level, uint32_t busy_timeout,
    ...
    virtual bool isPowered() { return _power_is_on; }
